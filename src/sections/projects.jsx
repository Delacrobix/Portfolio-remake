    ...
    <section
      ...
      <header className='text-center mb-12'>
        <div className='flex justify-center items-center gap-3 mb-4'>
          ...
          <h2 className='font-comfortaa font-bold text-4xl'>{t('projects.title')}</h2>
        </div>
            ...
            <Card
              ...
              <CardHeader className='flex-col items-start gap-3 pb-0'>
                <div className='w-full'>
                  <h3 className='font-bold text-2xl font-comfortaa mb-2'>{project.name}</h3>
              ...
              <CardBody className='py-4 space-y-4'>
                <div className='space-y-3'>
                  <div>
                    ...
                    <p className='text-sm text-default-600'>{project.problem}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-default-600'>{project.solution}</p>
                  </div>

                  {project.impact && (
                    <div className='bg-success-50 dark:bg-success-900/20 p-3 rounded-lg'>
                      <div className='flex items-start gap-2'>
                        <span className='text-lg'>{getImpactIcon(project.impactType)}</span>
                        <div>
